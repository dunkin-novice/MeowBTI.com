...
(function () {
    ...
    const EVERGREEN_PAGES = {
        ...
        'infj-entp': { type: 'compatibility', title: 'INFJ and ENTP Compatibility', related: ['infj', 'entp'], route: '/mbti/infj-entp/' },
        'intj-infp': { type: 'compatibility', title: 'INTJ and INFP Compatibility', related: ['intj', 'infp'], route: '/mbti/intj-infp/' },
        'enfp-infj': { type: 'compatibility', title: 'ENFP and INFJ Compatibility', related: ['enfp', 'infj'], route: '/mbti/enfp-infj/' },
        'entp-intj': { type: 'compatibility', title: 'ENTP and INTJ Compatibility', related: ['entp', 'intj'], route: '/mbti/entp-intj/' },
        'isfj-entp': { type: 'compatibility', title: 'ISFJ and ENTP Compatibility', related: ['isfj', 'entp'], route: '/mbti/isfj-entp/' },
