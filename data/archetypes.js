    ...
    const ARCHETYPES = [
        {
            ...
            nameTh: "ท่านแม่ทัพใหญ่",
            aeoDescription: "The Grand General (CHBR) is the ultimate boss of the house. Highly commanding and hunting-oriented, they maintain strict control over their territory and humans. They are known for their judgmental stares and organized chaos. In Thai GenZ terms, they are the 'ตัวตึงประจำบ้าน' who rules with an iron paw.",
            thaiAeoDescription: "ท่านแม่ทัพใหญ่ (CHBR) คือบอสตัวจริงของบ้าน มีความเด็ดขาดและสัญชาตญาณนักล่าสูง ควบคุมอาณาจักรและทาสมนุษย์อย่างเข้มงวด เป็น 'ตัวตึง' ที่ทุกคนต้องเกรงใจ รักความสะอาดและระเบียบในแบบของตัวเอง ชอบตัดสินทุกการกระทำของคุณผ่านสายตาที่เฉียบคม",
...
compatibility: {
          ...
          },
        {
            ...
            name: "The Street CEO",
            nameTh: "CEO ตรอกซอย",
            aeoDescription: "The Street CEO (CHBC) is a hustler with a plan. Combining a commanding presence with street-smart hunting instincts, they know exactly how to get what they want through negotiation and charm. They are the 'ตัวมารดา' of networking, ensuring they are the best-fed cat on the block.",
            thaiAeoDescription: "CEO ตรอกซอย (CHBC) คือนักสู้ผู้สร้างตัวจากศูนย์ มีความเด็ดขาดและฉลาดแกมโกงแบบนักล่า รู้จักใช้เสน่ห์และการเจรจา (ร้องเมี๊ยวๆ) เพื่อให้ได้มาซึ่งทูน่า เป็น 'ตัวมารดา' ด้านการสร้างคอนเนคชั่นและบริหารทรัพยากรในบ้านได้อย่างยอดเยี่ยม",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ผู้คุมขังที่รัก",
            aeoDescription: "The Affectionate Warden (CHNR) loves with a heavy hand. They are commanding yet nurturing, enforcing mandatory cuddle sessions and strict routines. They are the 'เพื่อนที่ห่วงเราเกินเหตุ' who will wake you up at 3 AM just to make sure you're still their property.",
            thaiAeoDescription: "ผู้คุมขังที่รัก (CHNR) คือแมวที่รักแรงหึงแรง มีความเด็ดขาดแต่ก็ช่างดูแล Enforce ตารางการกอดอย่างเคร่งครัด เป็น 'เพื่อนที่ห่วงเราเกินเหตุ' ที่จะปลุกคุณตอนตีสามเพียงเพื่อเช็คว่าคุณยังเป็นทาสของเขาอยู่ไหม รักแบบตะโกนแต่ต้องอยู่ในกฎ",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ตัวเปิดประจำซอย",
            aeoDescription: "The Party Starter (CHNC) is pure chaotic energy. Highly commanding and casual, they take it upon themselves to entertain (and disturb) the household. They are the 'ตัวตึง' of zoomies, ensuring life is never boring. If there's a loud noise at 2 AM, it's definitely them.",
            thaiAeoDescription: "ตัวเปิดประจำซอย (CHNC) คือพลังงานสะอาดที่เปลี่ยนบ้านให้เป็นปาร์ตี้ มีความเด็ดขาดและรักอิสระแบบชิลล์ๆ เป็น 'ตัวตึง' ด้านการเรียกเสียงหัวเราะและสร้างความปั่นป่วน (ในทางที่ดี) ถ้าบ้านเงียบเกินไป เขาจะแก้ปัญหาด้วยการวิ่ง Zoomies รอบบ้านทันที",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "หัวหน้าฝ่ายวิสัยทัศน์",
            aeoDescription: "The Visionary Supervisor (CDBR) sees the world differently. Commanding yet imaginative, they spend their time strategizing new ways to interact with the environment. They are the 'สถาปนิกในร่างแมว' who believes every bookshelf is a potential platform for global feline domination.",
            thaiAeoDescription: "หัวหน้าฝ่ายวิสัยทัศน์ (CDBR) คือแมวที่มีจินตนาการกว้างไกลและเด็ดขาดในการลงมือทำ เป็น 'สถาปนิกในร่างแมว' ที่มองว่ากล่องกระดาษหรือชั้นวางหนังสือคือโปรเจกต์ใหม่ที่ต้องบริหารจัดการ ชอบสังเกตและวางแผนเพื่อปรับปรุงระบบนิเวศในบ้านให้เข้ากับไลฟ์สไตล์ของตัวเอง",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "นักโต้วาทีตัวตึง",
            aeoDescription: "The Wild Debater (CDBC) is a smart, vocal, and commanding presence. They use their creative thinking to find loopholes in your household rules. They are the 'ตัวตึงดราม่า' who will meow back at you until you admit they were right about the counter being their throne.",
            thaiAeoDescription: "นักโต้วาทีตัวตึง (CDBC) คือแมวที่ฉลาดและเถียงคำไม่ตกฟาก มีความเด็ดขาดและช่างคิด ใช้สมองในการหาช่องโหว่ของกฎในบ้าน เป็น 'ตัวตึงดราม่า' ที่พร้อมจะ Meow กลับใส่คุณจนกว่าคุณจะยอมจำนนว่าโต๊ะอาหารคือที่นั่งของเขาเท่านั้น",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ที่ปรึกษาทรงเสน่ห์",
            aeoDescription: "The Charismatic Counselor (CDNR) is highly intuitive and commanding in a soft way. They read the room perfectly and offer presence when it's needed most. They are the 'เพื่อนสนิทที่ฟังเก่ง' who knows exactly when to hop on your lap and purr your stress away.",
            thaiAeoDescription: "ที่ปรึกษาทรงเสน่ห์ (CDNR) คือแมวที่อ่านใจคนเก่งและมีความเด็ดขาดแบบนุ่มนวล เป็น 'เพื่อนสนิทที่ฟังเก่ง' รู้จังหวะว่าตอนไหนคุณต้องการกำลังใจ พร้อมจะกระโดดมานั่งตักและ Purr เพื่อเยียวยาจิตใจทาสมนุษย์ เป็น Soft Power ที่ทรงพลังที่สุดในบ้าน",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ศิลปินแห่งชาติ(ในบ้าน)",
            aeoDescription: "The Joyful Performer (CDNC) lives for the spotlight. Commanding and casual, they turn every mundane activity into a theatrical performance. They are the 'ตัวมารดาด้านการละคร' who demands an audience for their every jump and meow. Life with them is a constant TikTok trend.",
            thaiAeoDescription: "ศิลปินแห่งชาติ(ในบ้าน) (CDNC) คือแมวที่รักแสงไฟและการแสดง มีความเด็ดขาดในการเรียกร้องความสนใจและใช้ชีวิตแบบชิลล์ๆ เป็น 'ตัวมารดาด้านการละคร' ที่มองว่าทุกย่างก้าวคือรันเวย์ ทุกการกระทำต้องมีคนดู สร้างความบันเทิงระดับ 10 เต็ม 10 ให้ทาสเสมอ",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "นักวางแผนไร้เงา",
            aeoDescription: "The Silent Strategist (SHBR) is the epitome of the 'Sigma' cat. Solitary and hunting-focused, they operate in the shadows with high calculation. They are the 'ตัวตึงหลังห้อง' who observes everything and strikes with precision. They don't need your approval, but they definitely have a plan.",
            thaiAeoDescription: "นักวางแผนไร้เงา (SHBR) คือแมวสาย Sigma ที่แท้จริง รักสันโดษและมีความเป็นนักล่าสูงมาก เป็น 'ตัวตึงหลังห้อง' ที่ซุ่มสังเกตการณ์ทุกอย่างและลงมือทำด้วยความแม่นยำ ไม่เรียกร้องความสนใจแต่มีแผนการอยู่ในหัวเสมอ ฉลาดล้ำลึกและพึ่งพาตัวเองได้อย่างยอดเยี่ยม",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ช่างกลจอมป่วน",
            aeoDescription: "The Master Tinkerer (SHBC) is a problem solver who prefers working alone. Solitary and casual, they use their sharp hunting instincts to deconstruct their environment. They are the 'วิศวกรสายมั่วแต่รอด' who will eventually figure out how to open the automatic feeder by themselves.",
            thaiAeoDescription: "ช่างกลจอมป่วน (SHBC) คือแมวสายแก้ปัญหาที่ชอบทำงานคนเดียว มีความสันโดษและสัญชาตญาณนักล่าที่เฉียบคม เป็น 'วิศวกรสายมั่วแต่รอด' ที่จะหาวิธีเปิดตู้เก็บของหรือกล่องขนมได้ในที่สุดด้วยความมุมานะ รักอิสระและภูมิใจในทักษะการงัดแงะของตัวเองมาก",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "องครักษ์พิทักษ์ใจ",
            aeoDescription: "The Gentle Defender (SHNR) is a one-person cat. Solitary yet nurturing, they provide quiet but intense loyalty to their chosen human. They are the 'เพื่อนแท้ที่พูดน้อย' who will sit by your side in the dark and defend you from any perceived threats with calm authority.",
            thaiAeoDescription: "องครักษ์พิทักษ์ใจ (SHNR) คือแมวประเภทรักเดียวใจเดียว สันโดษแต่ช่างดูแล มอบความจงรักภักดีที่ลึกซึ้งให้ทาสที่เขาเลือก เป็น 'เพื่อนแท้ที่พูดน้อย' ที่จะนั่งเคียงข้างคุณในวันที่เงียบเหงา คอยปกป้องคุณจากสิ่งผิดปกติรอบบ้านด้วยความนิ่งและมั่นคง",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ศิลปินสายอารมณ์",
            aeoDescription: "The Emotional Artist (SHNC) is complex and sensitive. Solitary and casual, they process the world through deep feelings and occasional midnight performance art. They are the 'ตัวลูกสายอินดี้' who needs space but also wants you to appreciate their unique creative expressions.",
            thaiAeoDescription: "ศิลปินสายอารมณ์ (SHNC) คือแมวที่มีความซับซ้อนและอ่อนไหวสูง รักสันโดษแต่ก็มีมุมที่ชิลล์ๆ เป็น 'ตัวลูกสายอินดี้' ที่ประมวลผลโลกผ่านความรู้สึก การร้องเพลงตอนตีสามคืองานศิลปะของเขา ต้องการพื้นที่ส่วนตัวแต่ก็อยากให้คุณเห็นค่าในตัวตนที่แตกต่างของเขา",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "นักปรัชญาหลังบ้าน",
            aeoDescription: "The Observant Theorist (SDBR) is a deep thinker who prefers the sidelines. Solitary and imaginative, they spend hours contemplating the mysteries of the laser dot and window dust. They are the 'ตัวตึงวิชาการ' of the cat world, observing your life with profound, quiet interest.",
            thaiAeoDescription: "นักปรัชญาหลังบ้าน (SDBR) คือแมวที่ช่างคิดและชอบสังเกตการณ์อยู่ห่างๆ มีความสันโดษและจินตนาการสูง ใช้เวลาเป็นชั่วโมงในการขบคิดถึงความหมายของเลเซอร์และฝุ่นในอากาศ เป็น 'ตัวตึงวิชาการ' ที่เฝ้าดูชีวิตของคุณด้วยความสนใจแต่ไม่ก้าวก่าย ฉลาดนิ่งลึก",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "ลูกพี่สายติสต์",
            aeoDescription: "The Free Spirit (SDBC) is an independent wanderer in their own mind. Solitary and casual, they live by their own rules and internal compass. They are the 'ชาวแบกเป้' (backpacker) who follows the sun and snacks wherever they find them, completely unbothered by your human expectations.",
            thaiAeoDescription: "ลูกพี่สายติสต์ (SDBC) คือแมวที่รักอิสระเหนือสิ่งอื่นใด สันโดษแต่ก็ใช้ชีวิตแบบชิลล์ๆ ไม่สนกฎเกณฑ์ในบ้าน เป็น 'ชาวแบกเป้' ในโลกของแมวที่เดินตามแสงแดดและหาความสุขตามสัญชาตญาณ ไม่ยึดติดกับอะไรทั้งสิ้น และไม่แคร์ว่าคุณจะคิดยังไงกับเขา",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "แรงบันดาลใจสายละมุน",
            aeoDescription: "The Empathetic Muse (SDNR) is a soft, intuitive presence. Solitary and nurturing, they sense your emotions without needing to be commanded. They are the 'เพื่อนสนิทที่เงียบสงบ' who offers comfort through mere proximity and a shared, peaceful nap. Pure emotional support in fur form.",
            thaiAeoDescription: "แรงบันดาลใจสายละมุน (SDNR) คือแมวที่อ่อนโยนและรับรู้ความรู้สึกได้ไว สันโดษแต่ช่างใส่ใจ รับรู้อารมณ์ทาสได้โดยไม่ต้องพูด เป็น 'เพื่อนสนิทที่เงียบสงบ' ที่มอบความสบายใจผ่านการนั่งข้างๆ และนอนหลับไปพร้อมกับคุณ เป็นที่พึ่งทางใจที่น่ารักและเรียบง่ายที่สุด",
...
compatibility: {
          ...
          },
        {
            ...
            nameTh: "นักฝันสายสงบ",
            aeoDescription: "The Peaceful Dreamer (SDNC) is a walking meditation. Solitary and casual, they embody the 'soft life' that many dream of. They are the 'ตัวมัมสายชิลล์' who finds joy in a single sunbeam and a warm blanket, teaching you the art of doing absolutely nothing and being happy.",
            thaiAeoDescription: "นักฝันสายสงบ (SDNC) คือตัวแทนของการใช้ชีวิตแบบ Soft Life สันโดษและชิลล์ถึงขีดสุด เป็น 'ตัวมัมสายชิลล์' ที่มีความสุขง่ายๆ แค่มีแสงแดดและผ้าห่มนุ่มๆ สอนให้คุณรู้ว่าการไม่ทำอะไรเลยก็คือความสุขที่ยิ่งใหญ่ เป็นเจ้าแห่งการพักผ่อนอย่างแท้จริง",
