...
(function () {
    const STRINGS = {
        ...
        moodQEnergy:       { en: "What’s your energy doing today?", th: "วันนี้พลังงานคุณเป็นยังไง?" },
        moodEnergyLow:     { en: "low battery",                th: "แบตต่ำ" },
        moodEnergySteady:  { en: "soft but functional",        th: "นุ่มๆ แต่ยังไหว" },
        moodEnergyWired:   { en: "too many tabs open",         th: "เปิดแท็บในหัวเยอะไป" },
        moodEnergyChaotic: { en: "feral sparkle mode",         th: "โหมดวุ่นวายวิบวับ" },
        moodQSocial:       { en: "How visible do you feel?",   th: "วันนี้อยากให้คนเห็นเราแค่ไหน?" },
        moodSocialHidden:  { en: "do not perceive me",         th: "อย่าเพิ่งรับรู้ถึงฉัน" },
        moodSocialSelective: { en: "only my chosen people",    th: "เฉพาะคนที่เลือกแล้ว" },
        moodSocialOpen:    { en: "I can be perceived",         th: "พอให้คนเห็นได้" },
        moodSocialLoud:    { en: "group chat main character",  th: "ตัวเอกแชทกลุ่ม" },
        moodQTexture:      { en: "What’s the texture inside?", th: "ข้างในตอนนี้มีผิวสัมผัสแบบไหน?" },
        moodTextureSoft:   { en: "soft",                       th: "นุ่ม" },
        moodTextureHeavy:  { en: "heavy",                      th: "หนัก" },
        moodTextureSharp:  { en: "sharp",                      th: "คม" },
        moodTextureFloaty: { en: "floaty",                     th: "ลอยๆ" },
        moodQNeed:         { en: "What would help most?",      th: "อะไรจะช่วยที่สุดตอนนี้?" },
        moodNeedRest:      { en: "rest",                       th: "พัก" },
        moodNeedClarity:   { en: "clarity",                    th: "ความชัดเจน" },
        moodNeedValidation:{ en: "validation",                 th: "การยืนยันว่าเรารู้สึกได้" },
        moodNeedMovement:  { en: "movement",                   th: "ขยับร่างกาย" },
